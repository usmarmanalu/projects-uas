...
import 'package:projects_uas/shared/data/models/todo_item.dart';
import 'package:projects_uas/shared/widgets/themes/app_text_styles.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  String undoneTaskQuantityMessage(int listLength) {
    final messageBodyPluralConcordance = listLength > 1 ? 'tugas' : 'tugas';
    final messageBody = listLength != 0 ? listLength.toString() : 'tidak ada';
